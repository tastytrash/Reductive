...
public class LapisExperienceBottleItem extends Item implements ProjectileItem {
    public LapisExperienceBottleItem(final Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResult use(final Level level, final Player player, final InteractionHand hand) {
        ...
        if (level instanceof ServerLevel serverLevel) {
            Projectile.spawnProjectileFromRotation(ThrownLapisExperienceBottle::new, serverLevel, itemStack, player, -20.0F, 0.7F, 1.0F);
        }
    ...
    public Projectile asProjectile(final Level level, final Position position, final ItemStack itemStack, final Direction direction) {
        return new ThrownLapisExperienceBottle(level, position.x(), position.y(), position.z(), itemStack);
    }
